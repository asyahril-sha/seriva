...
def status_handler(orchestrator: Orchestrator, admin_id: str):
    ...
    async def _handler(
        ...
        text_lines = [
            ...
            "📊 EMOSI & HUBUNGAN",
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
            "▪ Level hubungan: " + str(r.relationship_level) + "/12",
            "▪ Love: " + str(e.love),
            "▪ Longing (kangen): " + str(e.longing),
            "▪ Jealousy (cemburu): " + str(e.jealousy),
            "▪ Comfort (nyaman): " + str(e.comfort),
            "▪ Intimacy intensity: " + str(e.intimacy_intensity) + "/12",
            "▪ Mood: " + str(e.mood.value),
            "",
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
            "📍 LOKASI & SCENE",
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
            "▪ Lokasi: " + current_location + " " + location_private,
            "▪ Posture: " + (s.posture or "-"),
            "▪ Aktivitas: " + (s.activity or "-"),
            "▪ Suasana: " + (s.ambience or "-"),
            "▪ Waktu: " + (s.time_of_day.value if s.time_of_day else "-"),
            "▪ Jarak fisik: " + (s.physical_distance or "-"),
            "▪ Sentuhan terakhir: " + last_touch,
            "",
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
            "👕 STATUS PAKAIAN",
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
